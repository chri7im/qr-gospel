...
const LANGS = [
  ...
  },
  {
    ...
    hdr:'لطفاً زبان خود را انتخاب کنید',
    ...
    otl:'چیز دیگری...',
    t4:'چه چیزی دلت را سنگین می‌کند؟', s4:'به زبان خودت توضیح بده.', ph4:'اینجا بنویس...', b4:'ادامه دهید ←',
    ...
    tyT:'متشکرم!', tyS:'به زودی با شما تماس می‌گیریم.', tySkip:'برایت آرامش آرزو می‌کنیم.',
  ...
  },
  {
    ...
    tag:'आपके लिए एक संदेश', ldg:'आपका संदेश तैयार हो रहा है…', lmr:'मुझे और बताओ! →',
  ...
  },
  {
    ...
    sb:'提交', sk:'不了，谢谢',
    tyT:'谢谢！', tyS:'我们很快会与您联系。', tySkip:'愿你找到平安。',
...
const OPENING = {
  ...
  hi: ['एक कहानी है जो इतनी पुरानी है कि यह हमारे DNA का हिस्सा है।', 'यह कहानी तुम्हारी ', ' की असली जड़ को समझाती है।'],
